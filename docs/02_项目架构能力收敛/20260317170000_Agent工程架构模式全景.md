...
| 来源 | 链接 | 说明 |
|------|------|------|
| Google Cloud | [Choose a design pattern for your agentic AI system](https://docs.google.com/architecture/choose-design-pattern-agentic-ai-system) | 8 种设计模式 + 决策框架 |
